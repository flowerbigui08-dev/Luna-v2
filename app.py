...
st.markdown("""
    ...
    /* AJUSTE DE TAMAÑO EN SIMBOLOGÍA */
    .info-line { 
        color: white; 
        font-size: 18px; /* Texto más grande */
        margin-bottom: 15px; /* Más espacio entre líneas */
        display: flex; 
        align-items: center; 
    }
    .emoji-size { 
        font-size: 28px; /* Emoji más grande */
        margin-right: 15px; 
        width: 35px; 
        text-align: center; 
    }
